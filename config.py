...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MOON-CODES/MOONLIGHT",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Vishnusoni14")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/NAINCY_UPDATES")
